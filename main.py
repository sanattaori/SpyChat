...
def get_name():
    ...
    while sy_nm_len == 0 and sy_sa_len == 0:
        ...
        print(bcolors.HEADER+"Alright " + spy_full_name.capitalize() + " I'd like to know a little bit more about...", end='\n')
...
def get_age(c_name,c_rating):
    ...
    try:
        ...
        print(bcolors.WARNING + "Error age not valid"  , end='\nEnter Age Again\n')
...
def get_rating(check_rating, c_name):
    ...
    try:
        ...
        print(bcolors.FAIL+"Rating not valid"  , end='\nPlease try Again\n')
...
def show_error():
    global error
    error = True
    print(bcolors.FAIL+"Sorry You are not of the proper age to enter the spy community!")
...
def read_message():
    ...
    if len(output_path) == 0:
        ...
        try:
            ...
            print(bcolors.WARNING+'error exiting your entered output path invalid')
            exit()
    print(bcolors.BOLD+"Your secret message is :" + str(secrettext))
    if secrettext == 'SOS' or secrettext == 'SAVE ME':
        print(bcolors.WARNING + 'HELP is on the way sending backup'  )
    start_chat(spy_name, spy_age, spy_rating)
...
def send_msg():
    ...
    if len(output) == 0:
        ...
        print(bcolors.BOLD+"Your secret message image is ready! with file name 'secret.png' ")
    else:
        try:
            secret.save(output)
            print(bcolors.BOLD+"Your secret message image is ready! with file name " + output  )
        except Exception:
...
def view_friends_data():
    ...
    try:
        ...
        print(bcolors.FAIL+'Error no data in csv found')
